        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (status == CLOSE) {
                    ...
                    mItemView = childViewHolder.itemView.findViewById(R.id.item_layout);
                    mPosition = childViewHolder.getAdapterPosition();
                    mDeleteView = (ImageView) childViewHolder.itemView.findViewById(R.id.item_delete);
